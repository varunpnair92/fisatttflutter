...
Future<void> saveData() async {
  const url = 'http://144.24.153.172:4455/lab/laballot';  // URL for the normal request
  const continueUrl = 'http://144.24.153.172:4455/lab/laballot_continue';  // URL for continuing without conflict check
      ...
      if (conflictMessage.contains("Conflict detected")) {
        ...
        Get.defaultDialog(
          ...
          onConfirm: () async {
            ...
            formData.value["allot"] = "continue"; // Set allot flag to 'continue'
        ...
        Get.snackbar("Error", "Conflict not handled properly: $conflictMessage");
      }
    } else {
